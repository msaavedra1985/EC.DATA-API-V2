 ...
 * @param {string} [userData.tenant_id] - ID del tenant (opcional)
 ...
 * @param {string} [options.tenant_id] - Filtrar por tenant
...
export const listUsers = async (options = {}) => {
    try {
        ...
        if (tenant_id !== undefined) where.tenant_id = tenant_id;
